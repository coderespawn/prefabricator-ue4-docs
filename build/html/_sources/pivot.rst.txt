...
.. note::
   The default pivot will be snapped to the editor's current grid settings to avoid alignment issues
...
.. note::
   Make sure you do not select the prefab you are trying to modify but only the items inside of it
